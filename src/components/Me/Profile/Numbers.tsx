...
const InfoBox: React.FC<{number: number, text: string}> = ({number, text}) => {
  return <>
    <div className="rounded p-1 py-2 flex flex-col bg-gray-700 items-center">
...
const Numbers: React.FC = () => {
  ...
  return <>
      ...
      <div className="roudned m-2 grid grid-cols-3 gap-1 min-w-fit rounded-lg bg-gray-600 p-3">

...
const NotificationItem: React.FC<{
  ...
  byUserImage,
    ...
    return (
      <>
        <div
          className={`w-full rounded-lg border-l border-b border-gray-700 ${isSeen ? "bg-gray-800" : "bg-gray-900"
          ...
          <div className="flex flex-nowrap items-center gap-3">
            ...
            <div className="w-full">
              <div className="py-2 text-gray-300">
                <div className="flex gap-1">
                  {byUserId ? (
                    ...
                    <h2 className="font-semibold">{byUserName}</h2>
                  )}
                  <h2>{title}</h2>
                </div>
              </div>
              {!!subText && subText.length > 0 && (
                <Link href={link}>
                  <div
                    className={`flex rounded-lg border-l-2 ${isSeen ? "border-gray-700" : "border-gray-800"
                  ...
                  <h2
                    ...
                    onClick={() => {
                      controlModal.changeModal({
                        confirm: submitReply,
                        text: `Replying to ${byUserName || ""}${byUserName ? "'s" : ""
                          } Comment`,
                        confirmText: "Send",
                        includeNote: true,

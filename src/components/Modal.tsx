...
const Modal: React.FC = () => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 z-50 h-screen w-screen bg-gray-100 opacity-[0.15]"></div>
      <div className="fixed top-0 left-0 z-50 flex h-screen w-screen items-center justify-center">
        <div className="flex flex-col items-center gap-2 rounded-lg bg-gray-900 p-10 shadow-xl shadow-gray-800">
          ...
          <div className="flex gap-1">
            <h2
              className="rounded-lg cursor-pointer bg-green-600 p-1 px-3 hover:bg-green-700"
              onClick={() => {
            ...
            <h2
              className="rounded-lg bg-blue-600 cursor-pointer p-1 px-3 hover:bg-blue-700"
              onClick={() => {
